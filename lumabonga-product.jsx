...
// Pure/presentational — no internal state. Used by ProdSopEditorSheet for
// both the base SOP (draft=false) and the Test-composition draft SOP
// (draft=true) — both call sites supply their own callbacks.
